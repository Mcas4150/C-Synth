...
/**
*/
class MikeSynthAudioProcessorEditor  : public AudioProcessorEditor,
public Slider::Listener
{
public:
    MikeSynthAudioProcessorEditor (MikeSynthAudioProcessor&);
    ~MikeSynthAudioProcessorEditor();
...
private:
    ...
    MikeSynthAudioProcessor& processor;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MikeSynthAudioProcessorEditor)
};
